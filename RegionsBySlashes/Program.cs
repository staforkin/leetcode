...
Console.WriteLine(solution.RegionsBySlashes(new[] { " /", "/ " }));
...
public class Solution
{
    ...
    {    //find the corresponding position for current triangle. Thinks this 1D array as a 2D array and each element is an array of size 4.
        return (i * n + j) * 4 + k;
    }
}